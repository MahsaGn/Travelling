...
class leaderProfile extends React.Component {
  ...
  async componentWillMount() {
    ...
    var isuserProfile = path[1] == 'userProfile'
    console.log("isledaer profile________________________", isuserProfile)
    this.setState(
      {
    ...
    var id = path[2];
    console.log("in profile id is ", id);
    if (isuserProfile) {
      await this.props.userProfile(id);
    }
    else {
      await this.props.leaderProfile(id);
      let places = "";
      console.log(
